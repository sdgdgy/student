                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="${pageContext.request.contextPath}/class/update" method="post">
                                    <input class="form-control" type="hidden" name="ClassId" value="${classOne.get(0).getClassId()}">
                                    <div class="form-group">
                                        <label>班级名</label>
                                        <input class="form-control" type="text" value="${classOne.get(0).getClassName()}" name="ClassName" required>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" type="hidden" name="DepartmentId" value="${classOne.get(0).getDepartmentId()}" id="departmentid">
                                        <label>所属系别</label>
                                        <div class="input-group">
                                        <input class="form-control" type="text" name="DepartmentName" value="${classOne_department.get(0).getDepartmentName()}" id="departmentname" disabled required>
