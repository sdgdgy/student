                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a type="button" class="btn btn-primary" id="classid" href="">确定</a>
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
            </div><!-- /.modal -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <a class="btn btn-primary" href="${pageContext.request.contextPath}/PageJump/toAddClass">添加班级</a>
                                    <table class="table table-hover">
                                        ...
                                        <c:forEach var="class1" items="${requestScope.get('classlist')}">
                                            <tr>
                                                <td style="text-align:center">${class1.getClassId()}</td>
                                                <td style="text-align:center">${class1.getClassName()}</td>
                                                <td style="text-align:center">${class1.getDepartmentId()}</td>
                                                <td style="text-align:center">
                                                    <a href="${pageContext.request.contextPath}/PageJump/toUpdateClass?id=${class1.getClassId()}">更改</a> |
                                                    <a href="#myModal" data-toggle="modal" onclick="value(${class1.getClassId()})">删除</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
...
<script type="text/javascript">
    function value(id) {
        document.getElementById("classid").href="${pageContext.request.contextPath}/class/del/?id="+id;
    }
</script>
</body>
</html>