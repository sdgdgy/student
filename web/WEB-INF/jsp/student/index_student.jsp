      ...
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            <li class="nav-item active"><a href="${pageContext.request.contextPath}/PageJump/toStudentPage"><i class="mdi mdi-home"></i> 学生界面首页 </a></li>
          </ul>
        </nav>
      ...
      <nav class="navbar navbar-default">
        <div class="topbar">
          ...
          <div class="topbar-left">
            ...
            <span class="navbar-page-title"> 学生界面首页 </span>
          </div>
          ...
          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              ...
              <ul class="dropdown-menu dropdown-menu-right">
                <li> <a href="${pageContext.request.contextPath}/PageJump/toPersonalInformation_student"><i class="mdi mdi-account"></i> 个人信息</a> </li>
                <li> <a href="${pageContext.request.contextPath}/PageJump/toUpdatePassword_student"><i class="mdi mdi-lock-outline"></i> 修改密码</a> </li>
                <li class="divider"></li>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                    <c:forEach var="stumsg" items="${requestScope.get('studentMessageList')}">
                      <tr>
                        <td style="text-align:center">${stumsg.getId()}</td>
                        <td style="text-align:center">${stumsg.getName()}</td>
                        <td style="text-align:center">${stumsg.getCourseId()}</td>
                        <td style="text-align:center">${stumsg.getCourseName()}</td>
                        <td style="text-align:center">${stumsg.getCredit()}</td>
                        <td style="text-align:center">${stumsg.getMark()}</td>
                      </tr>
                    </c:forEach>
                    </tbody>
                  </table>
